          ...
          <div class="col-md-6">
            <div class="product-slider">
              <div id="slider" class="flexslider">
                <ul class="slides">
                  <li>
                    <img src="assets/images/t2_1.jpg" />
                  </li>
                  <li>
                    <img src="assets/images/t2_2.jpg" />
                  </li>
                  <li>
                    <img src="assets/images/t2_3.jpg" />
                  </li>
              ...
              <div id="carousel" class="flexslider">
                <ul class="slides">
                  <li>
                    <img src="assets/images/thumb t2_1.jpg" />
                  </li>
                  <li>
                    <img src="assets/images/thumb t2_2.jpg" />
                  </li>
                  <li>
                    <img src="assets/images/thumb t2_3.jpg" />
                  </li>
                  <!-- items mirrored twice, total of 12 -->
                </ul>
              </div>

          ...
          <div class="col-md-6">
            <div class="product-slider">
              <div id="slider" class="flexslider">
                <ul class="slides">
                  <li>
                    <img src="assets/images/jm1_1.jpeg" />
                  </li>
                  <li>
                    <img src="assets/images/jm1_2.jpeg" />
                  </li>
                  <li>
                    <img src="assets/images/jm1_3.jpeg" />
                  </li>
                  <li>
                    <img src="assets/images/jm1_4.jpeg" />
                  </li>
              ...
              <div id="carousel" class="flexslider">
                <ul class="slides">
                  <li>
                    <img src="assets/images/thumb jm1_1.jpg" />
                  </li>
                  <li>
                    <img src="assets/images/thumb jm1_2.jpg" />
                  </li>
                  <li>
                    <img src="assets/images/thumb jm1_3.jpg" />
                  </li>
                  <li>
                    <img src="assets/images/thumb jm1_4.jpg" />
                  </li>
                  <!-- items mirrored twice, total of 12 -->
                </ul>
              </div>
